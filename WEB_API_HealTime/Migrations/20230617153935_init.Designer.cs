            ...
            modelBuilder.Entity("WEB_API_HealTime.Models.Pessoas.ContatoPessoa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PessoaId = 1,
                            Celular = "11978486810",
                            CriadoEm = new DateTime(2023, 6, 17, 12, 39, 35, 103, DateTimeKind.Local).AddTicks(9171),
                            Email = "user@user.com"
                        });
                });
