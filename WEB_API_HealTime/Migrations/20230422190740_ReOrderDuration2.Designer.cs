...
namespace WEB_API_HealTime.Migrations
{
    ...
    [Migration("20230422190740_ReOrderDuration2")]
    partial class ReOrderDuration2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WEB_API_HealTime.Models.Pessoas.ContatoPessoa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PessoaId = 1,
                            Celular = "11978486810",
                            CriadoEm = new DateTime(2023, 4, 22, 16, 7, 40, 637, DateTimeKind.Local).AddTicks(4448),
                            Email = "user@user.com"
                        });
                });
            ...
            modelBuilder.Entity("WEB_API_HealTime.Models.Pessoas.Pessoa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = new byte[] { 86, 81, 28, 239, 199, 226, 184, 188, 113, 230, 9, 159, 197, 64, 158, 158, 165, 238, 215, 149, 5, 38, 122, 111, 254, 75, 185, 15, 188, 33, 125, 165, 99, 62, 40, 134, 140, 19, 148, 153, 185, 215, 68, 77, 46, 150, 87, 87, 18, 94, 127, 17, 120, 151, 32, 129, 201, 122, 252, 202, 176, 113, 197, 152 },
                            PasswordSalt = new byte[] { 219, 53, 102, 142, 24, 152, 103, 136, 201, 84, 134, 108, 196, 230, 149, 191, 26, 104, 132, 150, 190, 145, 51, 199, 5, 31, 0, 160, 152, 101, 181, 88, 35, 86, 111, 149, 93, 234, 224, 161, 124, 215, 118, 33, 108, 154, 7, 190, 107, 235, 36, 5, 55, 87, 105, 146, 113, 159, 138, 201, 93, 69, 144, 120, 143, 169, 212, 190, 72, 189, 11, 93, 49, 93, 15, 197, 96, 100, 92, 245, 178, 138, 179, 26, 97, 18, 37, 149, 119, 241, 236, 96, 140, 69, 85, 209, 173, 165, 36, 31, 191, 17, 239, 73, 135, 23, 18, 49, 191, 67, 212, 245, 194, 254, 148, 183, 60, 135, 117, 83, 37, 69, 252, 94, 46, 100, 184, 118 },
