...
namespace WEB_API_HealTime.Migrations
{
    ...
    [Migration("20230404231740_Atualizando_TypeNroLogradouro")]
    partial class Atualizando_TypeNroLogradouro
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WEB_API_HealTime.Models.Pessoas.ContatoPessoa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PessoaId = 1,
                            Celular = "11978486810",
                            CriadoEm = new DateTime(2023, 4, 4, 20, 17, 40, 244, DateTimeKind.Local).AddTicks(6510),
                            Email = "user@user.com"
                        });
                });
            ...
            modelBuilder.Entity("WEB_API_HealTime.Models.Pessoas.Pessoa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NomePessoa = "Dan",
                            PasswordHash = new byte[] { 255, 20, 153, 105, 190, 113, 138, 3, 163, 173, 185, 234, 107, 92, 29, 2, 227, 118, 17, 191, 91, 213, 1, 204, 6, 24, 136, 228, 202, 47, 118, 199, 74, 225, 113, 11, 31, 5, 34, 81, 208, 91, 215, 78, 178, 104, 217, 94, 165, 129, 90, 209, 136, 158, 74, 71, 167, 129, 59, 205, 140, 240, 20, 205 },
                            PasswordSalt = new byte[] { 166, 215, 57, 46, 74, 84, 85, 34, 123, 235, 157, 95, 77, 188, 186, 100, 68, 110, 97, 27, 117, 128, 66, 4, 174, 70, 192, 156, 35, 98, 155, 117, 160, 108, 9, 46, 28, 182, 202, 112, 54, 112, 152, 140, 239, 91, 94, 252, 4, 244, 164, 215, 250, 230, 246, 38, 160, 141, 151, 205, 111, 246, 203, 155, 96, 225, 47, 224, 100, 215, 174, 97, 151, 55, 173, 243, 220, 5, 103, 187, 133, 254, 209, 101, 137, 182, 210, 65, 221, 167, 87, 84, 65, 112, 155, 151, 68, 63, 84, 110, 78, 179, 75, 209, 142, 0, 145, 251, 139, 31, 9, 230, 19, 231, 39, 190, 239, 249, 160, 211, 17, 78, 104, 187, 48, 96, 214, 209 },
