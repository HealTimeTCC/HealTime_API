...
{
    /// <inheritdoc />
    public partial class CuidadorPaciente : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PessoaId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TipoPessoa = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    ...
                    EnderecoPessoa = table.Column<string>(type: "VARCHAR(40)", nullable: false),
                    BairroEnderecoPessoa = table.Column<string>(type: "VARCHAR(40)", nullable: true),
                    CidadeEnderecoPessoa = table.Column<string>(type: "VARCHAR(40)", nullable: false),
                    ComplementoPessoa = table.Column<string>(type: "VARCHAR(40)", nullable: true),
